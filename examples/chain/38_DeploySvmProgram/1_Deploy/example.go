...
func main() {
	...
	// link accounts
	res, err := LinkAccount(chainClient, clientCtx, cosmosPrivateKeys[0], ownerSvmPrivKey, 1000000000)
	if err != nil {
		panic(err)
	}

	// use pre-link, we will create those account using owner key after
